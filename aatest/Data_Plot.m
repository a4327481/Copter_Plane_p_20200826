wfunction varargout = Data_Plot(varargin)
...
% Last Modified by GUIDE v2.5 26-Oct-2020 15:25:34
...
if (len~=0)
    for i=1:len
        line(f{i},Spectrum{i},'color',linecolor(i-5*floor((i-1)/5)+1),'linestyle',line_style(ceil(i/5)),'linewidth',2);
    end
%     grid on;
%      lgd = legend(listtext);
       lgd=legend(listtext{1},num2str(out(1)));
end