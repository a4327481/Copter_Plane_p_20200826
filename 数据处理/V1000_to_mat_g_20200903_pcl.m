...
%     %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        algo_roll_in=double(typecast(uint8(temp),'int16')')/32768*1.1*10;
        temp=reshape([data(index_20,91:92)'],1,[]);
        algo_pitch_in=double(typecast(uint8(temp),'int16')')/32768*1.1*10;
        temp=reshape([data(index_20,93:94)'],1,[]);
        algo_yaw_in=double(typecast(uint8(temp),'int16')')/32768*1.1*10;
...
for i=1:length(data_bms_txt2)
        ...
        head=[head ,'\n'];
data_ck=data_6(:,1:i);
fid=fopen([filename,'V1000_bms2.dat'],'w');
fprintf(fid,head);
%     [count,num]=size(data_ck);
%     for i=1:count
%         for j=1:num
...
%     end
    fclose(fid); 
save([filename,'V1000_bms2.dat'],'data_ck','-ascii','-append' )
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
data_7 = [];
...
for i=1:length(data_um482)
        ...
        head=[head ,'\n'];
data_ck=data_16(:,1:i);
fid=fopen([filename,'V1000_um482.dat'],'w');
fprintf(fid,head);
%     [count,num]=size(data_ck);
%     for i=1:count
%         for j=1:num
...
for i=1:length(parserData)
        ...
        data_ck=data(:,1:i);
fid=fopen([filename,'V1000_BMS10.dat'],'w');
fprintf(fid,head);  
fclose(fid); 
