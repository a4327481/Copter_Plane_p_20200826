...
V10Log.ALD2.roll = ALD2(:,4)*HD;                          %   3. | rol     | roll                          | [F]   | [12:12]   | 
V10Log.ALD2.pitch = ALD2(:,5)*HD;                         %   4. | pit     | pitch                         | [F]   | [12:12]   | 
V10Log.ALD2.yaw = ALD2(:,6)*HD;                           %   5. | yaw     | yaw                           | [F]   | [12:12]   | 
...
V10Log.ALD2.pwm_out_0 = ALD2(:,11);                    %  10. | pw0     | pwm_out_0                     | [F]   | [12:12]   | 
V10Log.ALD2.pwm_out_1 = ALD2(:,12);                    %  11. | pw1     | pwm_out_1                     | [F]   | [12:12]   | 
V10Log.ALD2.pwm_out_2 = ALD2(:,13);                    %  12. | pw2     | pwm_out_2                     | [F]   | [12:12]   | 
V10Log.ALD2.pwm_out_3 = ALD2(:,14);                    %  13. | pw3     | pwm_out_3                     | [F]   | [12:12]   | 
...
V10Log.ALD3.current_loc_0 = ALD3(:,6);                 %   5. | cl0     | current_loc_0                 | [F]   | [12:12]   | 
V10Log.ALD3.current_loc_1 = ALD3(:,7);                 %   6. | cl1     | current_loc_1                 | [F]   | [12:12]   | 
V10Log.ALD3.curr_vel_0 = ALD3(:,8);                    %   7. | cv0     | curr_vel_0                    | [F]   | [12:12]   | 
V10Log.ALD3.curr_vel_1 = ALD3(:,9);                    %   8. | cv1     | curr_vel_1                    | [F]   | [12:12]   | 
V10Log.ALD3.curr_vel_2 = ALD3(:,10);                   %   9. | cv2     | curr_vel_2                    | [F]   | [12:12]   | 
V10Log.ALD3.curr_pos_0 = ALD3(:,11);                   %  10. | cp0     | curr_pos_0                    | [F]   | [12:12]   | 
V10Log.ALD3.curr_pos_1 = ALD3(:,12);                   %  11. | cp1     | curr_pos_1                    | [F]   | [12:12]   | 
V10Log.ALD3.rate_target_ang_vel_0 = ALD3(:,13);        %  12. | rvl0    | rate_target_ang_vel_0         | [F]   | [12:12]   | 
V10Log.ALD3.rate_target_ang_vel_1 = ALD3(:,14);        %  13. | rvl1    | rate_target_ang_vel_1         | [F]   | [12:12]   | 
V10Log.ALD3.rate_target_ang_vel_2 = ALD3(:,15);        %  14. | rvl2    | rate_target_ang_vel_2         | [F]   | [12:12]   | 
...
V10Log.ALD4.attitude_target_euler_rate_0 = ALD4(:,4);  %   3. | er0     | attitude_target_euler_rate_0  | [F]   | [12:12]   | 
V10Log.ALD4.attitude_target_euler_rate_1 = ALD4(:,5);  %   4. | er1     | attitude_target_euler_rate_1  | [F]   | [12:12]   | 
V10Log.ALD4.attitude_target_euler_rate_2 = ALD4(:,6);  %   5. | er2     | attitude_target_euler_rate_2  | [F]   | [12:12]   | 
V10Log.ALD4.attitude_target_euler_angle_0 = ALD4(:,7)*HD; %   6. | ea0     | attitude_target_euler_angle_0 | [F]   | [12:12]   | 
V10Log.ALD4.attitude_target_euler_angle_1 = ALD4(:,8)*HD; %   7. | ea1     | attitude_target_euler_angle_1 | [F]   | [12:12]   | 
V10Log.ALD4.attitude_target_euler_angle_2 = ALD4(:,9)*HD; %   8. | ea2     | attitude_target_euler_angle_2 | [F]   | [12:12]   | 
V10Log.ALD4.pos_target_0 = ALD4(:,10);                 %   9. | ptg0    | pos_target_0                  | [F]   | [12:12]   | 
V10Log.ALD4.pos_target_1 = ALD4(:,11);                 %  10. | ptg1    | pos_target_1                  | [F]   | [12:12]   | 
V10Log.ALD4.pos_target_2 = ALD4(:,12);                 %  11. | ptg2    | pos_target_2                  | [F]   | [12:12]   | 
V10Log.ALD4.vel_target_0 = ALD4(:,13);                 %  12. | vtg0    | vel_target_0                  | [F]   | [12:12]   | 
V10Log.ALD4.vel_target_1 = ALD4(:,14);                 %  13. | vtg1    | vel_target_1                  | [F]   | [12:12]   | 
V10Log.ALD4.vel_target_2 = ALD4(:,15);                 %  14. | vtg2    | vel_target_2                  | [F]   | [12:12]   | 
...
V10Log.ALD5.accel_target_0 = ALD5(:,4);                %   3. | acc0    | accel_target_0                | [F]   | [12:12]   | 
V10Log.ALD5.accel_target_1 = ALD5(:,5);                %   4. | acc1    | accel_target_1                | [F]   | [12:12]   | 
V10Log.ALD5.accel_target_2 = ALD5(:,6);                %   5. | acc2    | accel_target_2                | [F]   | [12:12]   | 
V10Log.ALD5.attitude_error_vector_0 = ALD5(:,7);       %   6. | vect0   | attitude_error_vector_0       | [F]   | [12:12]   | 
V10Log.ALD5.attitude_error_vector_1 = ALD5(:,8);       %   7. | vect1   | attitude_error_vector_1       | [F]   | [12:12]   | 
V10Log.ALD5.attitude_error_vector_2 = ALD5(:,9);       %   8. | vect2   | attitude_error_vector_2       | [F]   | [12:12]   | 
V10Log.ALD5.pos_error_0 = ALD5(:,10);                  %   9. | per0    | pos_error_0                   | [F]   | [12:12]   | 
V10Log.ALD5.pos_error_1 = ALD5(:,11);                  %  10. | per1    | pos_error_1                   | [F]   | [12:12]   | 
V10Log.ALD5.pos_error_2 = ALD5(:,12);                  %  11. | per2    | pos_error_2                   | [F]   | [12:12]   | 
V10Log.ALD5.vel_desired_2 = ALD5(:,13);                %  12. | veld2   | vel_desired_2                 | [F]   | [12:12]   | 
...
V10Log.ALD6.curr_alt = ALD6(:,13)/100;                     %  12. | curalt  | curr_alt                      | [F]   | [12:12]   | 
...
V10Log.ALD7.roll_target = ALD7(:,5)/100;                   %   4. | rotg    | roll_target                   | [F]   | [12:12]   | 
V10Log.ALD7.pitch_target = ALD7(:,6)/100;                  %   5. | pitg    | pitch_target                  | [F]   | [12:12]   | 
