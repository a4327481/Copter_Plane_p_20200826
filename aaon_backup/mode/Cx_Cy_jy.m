...
% i_ts=find(t_gps-t_start>0 ,1);
% i_te=find(t_gps-t_end>0 ,1);
% if (isempty(i_te))
% i_te=length(t_gps);
% end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% dV_f_5=[0; diff(V_gps_xyz_f_5)]/dt;
% dV_f_0_5=[0; diff(V_gps_xyz_f_0_5)]/dt;
% dV_f_0_1=[0; diff(V_gps_xyz_f_0_1)]/dt;
% hold on
for wlen=5:30
dV_f_1=(V_gps_xyz_f(1+wlen:end)-V_gps_xyz_f(1:end-wlen))/wlen/dt;
plot(dV_f_1(1+100:end-100))
end
% hold on
% plot(ts_f,dV_f_1,'LineWidth',2)
% plot(ts_f,dV_f_5,'LineWidth',2)
% plot(ts_f,dV_f_0_5,'LineWidth',2)

% plot(t_gps,V_gps_xyz)
% hold on
% plot(ts_f,V_gps_xyz_f_1)

X_f=m*dV_f_1+m*g*sind(theta_f(1:end-30));
Cx_f=X_f./q_f(1:end-30);
plot(ts_f(1:end-30),Cx_f./alpha_f(1:end-30))
 plot(ts_f(1:end-30),Cx_f)
plot(ts_f(1:end-30), alpha_f(1:end-30))
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
