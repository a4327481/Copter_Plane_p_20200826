function vel_forward_pct_out = forward_throttle_pctg()
...
vel_forward_min_pitch              = Copter_Plane.vel_forward_min_pitch;
...
pitch_target                       = AC_PosControl.pitch_target;
    ...
    vel_forward_integrator = constrain_value(vel_forward_integrator, 0, 1);  
    vel_forward_pct_out=-vel_forward_integrator * (vel_forward_tail_tilt_max) ;
