...
global Test_w
        ...
        AC_rate_roll_pid.kp                                      = 0.21   ;%ATC_RAT_RLL_P
        AC_rate_roll_pid.ki                                      = 0.15   ;%ATC_RAT_RLL_I
        ...
        AC_rate_pitch_pid.ki                                     = 0.15   ;%ATC_RAT_PIT_I
        ...
        AC_rate_pitch_pid.filt_D_hz                              = 8      ;%ATC_RAT_PIT_FLTD
        ...
        AC_PosControl.pid_accel_z.kimax                          = 100    ;%PSC_ACCZ_IMAX
        ...
        AC_PosControl.speed_cms                                  = 500    ;%PSC_SPEED
        ...
        AP_TECS.minSinkRate                                      = 2      ;%TECS_SINK_MIN
        AP_TECS.timeConstant                                     = 2      ;%TECS_TIME_CONST
        ...
        Copter_Plane.p_plane_c2p                                 = 0.9    ;%P_PLANE_C2P
        ...
        Copter_Plane.tail_tilt_c2p                               = -2000  ;%TAIL_TILT_C2P
        Copter_Plane.k_throttle_c2p                              = 0.3    ;%K_THR_C2P
        ...
        Copter_Plane.yaw_max_c2p                                 = 0.05   ;%YAW_MAX_C2P
        Copter_Plane.p_tilt_pitch_target                         = 0.5    ;%P_TILT_PIT_TAR
        Copter_Plane.tail_tilt_p2c                               = 0      ;%TAIL_TILT_P2C
        Copter_Plane.p_plane_p2c                                 = 1      ;%P_PLANE_P2C
        Copter_Plane.pitch_target_p2c                            = 500    ;%PITCH_TAR_P2C
        Copter_Plane.POSCONTROL_THROTTLE_CUTOFF_FREQ_p2c         = 0.10   ;%PSC_ACCZ_FLTP2C
        ...
        Copter_Plane.roll_limit_cd                               = 4500   ;%RLL_LIMIT_CD
        Copter_Plane.EAS_dem_cm                                  = 1900   ;%EAS_DEM_CM
        Copter_Plane.radius                                      = 60     ;%RADIUS
        Copter_Plane.loiter_direction                            = 1      ;%LOITER_DIR
        Copter_Plane.k_flap_TakeOff                              = -3500  ;%K_FLAP_TAKEOFF
        Copter_Plane.k_flap_Land                                 = 2000   ;%K_FLAP_LAND
        Copter_Plane.thr_out_min                                 = 0.40    ;%THR_OUT_MIN
        Copter_Plane.throttle_ground                             = 0.55   ;%THR_GROUND
        ...
        AC_PosControl.accel_z_cms                                = 200;%POSCONTROL_ACCEL_Z
        ...
        AC_PosControl.POSCONTROL_ACCEL_XY_MAX                    = 356.9329;
