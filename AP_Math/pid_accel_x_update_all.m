function output=pid_accel_x_update_all( target_in,  measurement,  limit)
 global dt
...
flags_reset_filter                  =AC_PosControl.pid_vel_x.flags_reset_filter;
target                              =AC_PosControl.pid_vel_x.target;
error                               =AC_PosControl.pid_vel_x.error;
error_last                          =AC_PosControl.pid_vel_x.error_last;
integrator                          =AC_PosControl.pid_vel_x.integrator;
derivative                          =AC_PosControl.pid_vel_x.derivative;
slew_amplitude                      =AC_PosControl.pid_vel_x.slew_amplitude;
slew_filter                         =AC_PosControl.pid_vel_x.slew_filterg;
last_sample                         =AC_PosControl.pid_vel_x.last_sample;
Dmod                                =AC_PosControl.pid_vel_x.Dmod;
...
%    modifier(float sample, float dt)
    ...
    AC_PosControl.pid_vel_x.flags_reset_filter  = flags_reset_filter;
    AC_PosControl.pid_vel_x.target              = target;
    AC_PosControl.pid_vel_x.error               = error;
    AC_PosControl.pid_vel_x.error_last          = error_last ;

    AC_PosControl.pid_vel_x.integrator          = integrator;
    AC_PosControl.pid_vel_x.derivative          = derivative;
    AC_PosControl.pid_vel_x.Dmod                = Dmod;
    AC_PosControl.pid_vel_x.slew_amplitude      = slew_amplitude;
    AC_PosControl.pid_vel_x.slew_filterg        = slew_filter;
    AC_PosControl.pid_vel_x.last_sample         = last_sample;
